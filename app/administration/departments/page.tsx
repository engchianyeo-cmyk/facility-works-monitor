...
export default async function AdministrationDepartmentsPage() {
      ...
      <main className="mx-auto max-w-xl p-8">
        <div className="rounded-xl border border-red-200 bg-red-50 p-6">
          ...
          <p className="mt-2 text-sm text-red-800">
            An active Administrator account is required to manage departments.
          </p>
        </div>
      </main>
    );
    ...
    <main className="mx-auto max-w-7xl space-y-6 p-6 sm:p-8">
      <div>
        ...
        <p className="mt-1 text-sm text-slate-500">
          Maintain department structure, managers, cost centres and availability.
        </p>
      </div>
