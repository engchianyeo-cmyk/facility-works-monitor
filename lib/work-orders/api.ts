...
const HTTP_BY_CODE: Record<string, number> = {
  ...
  FINAL_COST_REQUIRED: 409,
  FINANCIAL_DISPOSITION_REQUIRED: 409,
  FINANCIAL_RECORD_IMMUTABLE: 409,
  PAYMENT_ALREADY_RECORDED: 409,
  PAYMENT_RECONCILIATION_REQUIRED: 409,
  ACTUAL_COST_MISMATCH: 409,
  INSUFFICIENT_QUOTATIONS: 409,
  DUPLICATE_CONTRACTOR_QUOTATION: 409,
