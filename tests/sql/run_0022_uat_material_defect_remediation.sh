...
$PSQL -f /workspace/tests/sql/fmworks_pre_0012_bootstrap.test.sql
...
$PSQL -f /workspace/tests/sql/0021_fresh_install_trust_contract_repair.test.sql
$PSQL -f /workspace/supabase/migrations/0022_uat_material_defect_remediation.sql
$PSQL -f /workspace/tests/sql/0022_uat_material_defect_remediation.test.sql
