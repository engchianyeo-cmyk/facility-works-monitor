...
$PSQL -Atqc "select 1 / (1 - sign(count(*))) from public.departments"
$PSQL -f /workspace/supabase/migrations/0024_department_master_data_baseline.sql
$PSQL -f /workspace/tests/sql/0024_department_master_data_baseline.test.sql
